...
void TestMap::makeAStarNode(float _intervalX, float _intervalZ)
{
	...
	//renderer_->SetRenderingPipeLine("DeferredNavTile");
	//renderer_->SetMesh(tileVertexBuffer_, tileIndexBuffer_);
