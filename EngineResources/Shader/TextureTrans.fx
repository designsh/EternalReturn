...
cbuffer TextureTransAtlasData : register(b1)
{
    // 0.0f 0.0f 
...
VertexOut TextureTrans_VS(VertexIn _in)
{
    VertexOut Out;
...
cbuffer TextureTransAtlasResultColor : register(b0)
{
    float4 vMulColor;
    float4 vPlusColor;
};
...
float4 TextureTrans_PS(VertexOut _in) : SV_Target0
{
